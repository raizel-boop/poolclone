...
function handleMouseDown(evt) {
    ...
    var mx = (evt.pageX - canvasOffset.x) / canvasScale.x;
    var my = (evt.pageY - canvasOffset.y) / canvasScale.y;
    Mouse._initial = new Vector2(mx, my);
    if (evt.which === 1) {
        if (!Mouse._left.down)
...
Object.defineProperty(Mouse_Singleton.prototype, "initial",
    {
        get: function () {
...
Object.defineProperty(Mouse_Singleton.prototype, "inverse",
    {
        get: function () {
